...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Hobby', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='user.hobby')),
        ...
        migrations.AddField(
            ...
            name='hobby',
            field=models.ManyToManyField(through='user.UserProfileHobby', to='user.hobby', verbose_name='취미'),
        ),
    ]
